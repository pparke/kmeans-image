...
exports.coordsToOffset = coordsToOffset;
exports.offsetToCoords = offsetToCoords;
...
exports.onlyListenToDropEventsFrom = onlyListenToDropEventsFrom;
function createCanvas(width, height, elem) {
...
function crosshair(ctx, point) {
  ...
  try {
    for (var _iterator = Object.values(arms)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var arm = _step.value;
...
function swatch(ctx, color, rect) {
...
function coordsToOffset(x, y, width) {
  return x + y * width;
}

function offsetToCoords(i, width) {
  var x = i % width;
  var y = Math.floor(i / width);
  return { x: x, y: y };
}

function randomNext(arr) {
  var indices = Array.from({ length: arr.length }, function (v, i) {
    return i;
  });
  return function next() {
    var i = Math.floor(Math.random() * indices.length);
    var index = indices.splice(i, 1);
    if (indices.length === 0) {
      indices = Array.from({ length: arr.length }, function (v, j) {
        return j;
      });
    }
    return arr[index];
...
function waitFor(ids) {
  return new Promise(function (resolve, reject) {
    var observer = new MutationObserver(function (mutations, self) {
      var allPresent = ids.map(function (id) {
...
function createDropzone(elem, cb) {
  elem.addEventListener('dragover', handleDragOver, false);
  elem.addEventListener('drop', function (e) {
    return handleFileSelect(e, cb);
  }, false);
}
...
function onlyListenToDropEventsFrom(elems) {
...
var _Kmeans = __webpack_require__(117);
...
var WIDTH = 500;
var kmeans = new _Kmeans2.default();
var K = 10;
var iterations = 5;
var filename = void 0;
var stop = false;

(0, _util.onLoad)(setupListeners);

function setupListeners() {
  var dropzoneId = 'drop-zone';

  (0, _util.onlyListenToDropEventsFrom)([dropzoneId]);

  // load the image when it is dropped
  // document.getElementById(dropzoneId)
  (0, _util.createDropzone)(document.body, load);

  document.getElementById('k-value').onchange = function (e) {
    K = parseInt(e.target.value, 10);
  };

  document.getElementById('iterations').onchange = function (e) {
...
function setupCanvases() {
  var file = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'img/nic_cage.jpg';
  var img, HEIGHT, canvasContainer, ctx, ctx2, imageData;
  return regeneratorRuntime.async(function setupCanvases$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap((0, _util.loadImage)(file));

        case 2:
          img = _context.sent;
          HEIGHT = WIDTH * (img.height / img.width);
          canvasContainer = document.getElementById('canvas-container');
          ctx = (0, _util.createCanvas)(WIDTH, HEIGHT, canvasContainer);

          ctx.canvas.id = 'source-canvas';
          ctx2 = (0, _util.createCanvas)(WIDTH, HEIGHT, canvasContainer);
          ...
          return _context.abrupt('return', { ctx: ctx, ctx2: ctx2, HEIGHT: HEIGHT, imageData: imageData });
...
function setupKmeans(_ref) {
  var ctx = _ref.ctx,
      ctx2 = _ref.ctx2,
      HEIGHT = _ref.HEIGHT,
      imageData = _ref.imageData;

  var observations = ctx.getImageData(0, 0, WIDTH, HEIGHT).data;

  kmeans.init(K, observations, WIDTH);
  kmeans.run(iterations);

  return { kmeans: kmeans, ctx: ctx2, imageData: imageData, width: WIDTH };
}
...
function main(_ref2) {
  ...
  var data, centroid, r, g, b, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, point, i;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          data = imageData.data;
          _context2.next = 3;
          return regeneratorRuntime.awrap(kmeans.step());

        case 3:
          centroid = _context2.sent;
          ...
          setTimeout(main.bind(null, { kmeans: kmeans, ctx: ctx, imageData: imageData, width: width }), 50);
          _context2.next = 9;
          break;
        ...
        case 9:
          r = Math.floor(centroid.r);
          g = Math.floor(centroid.g);
          b = Math.floor(centroid.b);
          _iteratorNormalCompletion = true;
          _didIteratorError = false;
          _iteratorError = undefined;
          _context2.prev = 15;

          for (_iterator = centroid.cluster[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            point = _step.value;
            i = (0, _util.coordsToOffset)(point.x, point.y, width) * 4;
...
function drawSwatches(ctx, centroids) {
  ...
  try {
    for (var _iterator2 = centroids[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var centroid = _step2.value;

      var color = { r: Math.floor(centroid.r), g: Math.floor(centroid.g), b: Math.floor(centroid.b), a: 1 };
      var rect = { x: centroid.x + 10, y: centroid.y + 10, w: 20, h: 20 };
      (0, _util.swatch)(ctx, color, rect);
    }
  } catch (err) {
...
var _Worker = __webpack_require__(119);
...
var Centroid = function () {
  function Centroid(cluster) {
    ...
    this.x = 0;
    this.y = 0;
    this.worker = new _Worker2.default(function () {
      function mean(cluster) {
        var size = cluster.size;
        var o = { r: 0, g: 0, b: 0, x: 0, y: 0 };
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
          for (var _iterator = cluster[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var ob = _step.value;
    ...
    this.worker.onerror = function (message, filename, line) {
      return console.log(message, filename, line);
    };
  }
  ...
  _createClass(Centroid, [{
    ...
    value: function calculate() {
      var vals;
      return regeneratorRuntime.async(function calculate$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(this.worker.mean(this.cluster));
    ...
    key: 'nearest',
    value: function nearest(centroids, ob) {
      return centroids.sort(function (a, b) {
        return a.distance(ob) - b.distance(ob);
      })[0];
    }
  }]);
...
var _Centroid = __webpack_require__(116);

var _Centroid2 = _interopRequireDefault(_Centroid);

var _Observation = __webpack_require__(118);
...
var Kmeans = function () {
  ...
  _createClass(Kmeans, [{
    key: 'init',
    value: function init(K, observations, width) {
      this.teardown();
      this.K = K;
    ...
    key: 'run',
    value: function run() {
      var iterations = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;
    ...
    value: regeneratorRuntime.mark(function _run() {
      ...
      var done, count, results, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, result;

      return regeneratorRuntime.wrap(function _run$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              done = false;
            ...
            case 2:
              ...
              results = this.centroids.map(function (c) {
                return c.calculate();
              });
              _iteratorNormalCompletion = true;
              _didIteratorError = false;
      ...
      }, _run, this, [[8, 19, 23, 31], [24,, 26, 30]]);
    })
  }, {
    key: 'createClusters',
    value: function createClusters(K) {
    ...
    key: 'randomInitialization',
    value: function randomInitialization(clusters, observations, width) {
      var next = (0, _util.randomNext)(clusters);
      for (var i = 0; i < observations.length; i += 4) {
        var _observations$slice = observations.slice(i, i + 3),
            _observations$slice2 = _slicedToArray(_observations$slice, 3),
            r = _observations$slice2[0],
            g = _observations$slice2[1],
            b = _observations$slice2[2];

        var _offsetToCoords = (0, _util.offsetToCoords)(i / 4, width),
            x = _offsetToCoords.x,
            y = _offsetToCoords.y;

        var ob = new _Observation2.default(r, g, b, x, y);
        var index = Math.floor(Math.random() * clusters.length);
        next().add(ob);
      }
    }
  }, {
    key: 'createCentroids',
    value: function createCentroids(clusters) {
      return clusters.map(function (c) {
        return new _Centroid2.default(c);
      });
    }
    ...
    key: 'assignment',
    value: function assignment(clusters, centroids) {
      var done = true;
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;
      ...
      try {
        for (var _iterator2 = clusters[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          try {
            for (var _iterator3 = cluster[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              var ob = _step3.value;

              var nearest = _Centroid2.default.nearest(centroids, ob);
...
var Observation = function Observation(r, g, b, x, y) {
...
var handler = {
  construct: function construct(target, args) {
    ...
    var methods = /function\s+(\w+)\s*\(.*\)/g.exec(body).slice(1);
    var cases = methods.map(function (fn) {
      return '\n\tcase \'' + fn + '\':\n\t\tresult = ' + fn + '(...args);\n\t\tbreak;\n';
    }).join('');

    // this is the original worker source
    var source = target.toString().trim();
    ...
    var blob = new Blob([source.toString().replace(/^[^{]*{\s*([\d\D]*)\s*}[^}]*$/, '$1')], { type: 'text/javascript' });
    ...
    worker.onmessage = function (e) {
      var key = e.data[0];
      var status = e.data[1];
      var results = e.data.slice(2);

      if (status === 'success') {
        var _results$key;

        return (_results$key = this.results[key]).resolve.apply(_results$key, _toConsumableArray(results));
      }
    ...
    /**
      ...
      */
    methods.reduce(function (wrkr, mthd) {
      ...
      wrkr[mthd] = function () {
        ...
        wrkr.postMessage([mthd].concat(args));
...
exports.default = new Proxy(onmessage, handler);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(114), __webpack_require__(302)))
